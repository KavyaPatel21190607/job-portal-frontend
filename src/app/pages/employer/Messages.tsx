      ...
      if (encryptionReady) {
        try {
          ...
          if (recipientPublicKey && senderPublicKey) {
            ...
            console.warn('One or both public keys missing, sending unencrypted');
          }
        } catch (error) {
                    ...
                    >
                      ...
                      <p
                        className={`text-xs mt-1 ${
                          msg.sender._id === currentUser?._id ? 'text-purple-100' : 'text-gray-500'
                        }`}
                      >
            ...
            <div className="border-t p-4">
              <form onSubmit={handleSendMessage} className="flex gap-2">
                <Input
                  ...
                  disabled={sending}
                />
                <Button type="submit" className="bg-purple-600 hover:bg-purple-700" disabled={sending}>
                  {sending ? (
